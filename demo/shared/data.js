...
window.DATA = {
  ...
  notifications: [
    ...
    { id: 'N013', type: 'acceptance-invite', title: '验收评审邀请 — OA协同办公平台升级', content: '诚邀您参加「OA协同办公平台升级」验收评审。', sender: '系统', sendTime: '2025-01-20 09:00', recipients: ['expert'], level: 'info', readStatus: {'张国强':true,'陈志远':true}, deliveryStatus: {'张国强':'delivered','陈志远':'delivered'}, channel: ['system','email'] },
  ...
  expertInvites: [
    {
      ...
      invites: [
        { expertId: 'E001', name: '张国强', isExternal: false, status: '已确认' },
        { expertId: 'E003', name: '陈志远', isExternal: true,  status: '已确认' },
        { expertId: 'E004', name: '王小燕', isExternal: false, status: '待回复' },
        { expertId: 'E006', name: '赵明华', isExternal: true,  status: '已确认' },
        { expertId: 'E009', name: '吴晓峰', isExternal: false, status: '已拒绝' },
      ]
    },
  ],
