...
registerView('notification-template', function() {
  ...
  const _tmplData = [
    ...
    { module:'需求征集', moduleIndex:1, nodeKey:'1-1', nodeLabel:'信息办发布征集通知',
      seq:1, notifKind:'待阅', channels:['system','email'],
    ...
    { module:'需求征集', moduleIndex:1, nodeKey:'1-2', nodeLabel:'指派项目负责人',
      seq:3, notifKind:'待办', channels:['system','dingding'],
    ...
    { module:'需求征集', moduleIndex:1, nodeKey:'1-3', nodeLabel:'需求申请表提交单位审批',
      seq:4, notifKind:'待办', channels:['system','dingding'],
      recipients:'UnitLeader',
      title:'【待审批】「{{项目名称}}」需求申请表待您审批',
      body:'申报人：{{经办人姓名}}，预估预算：{{预算金额}}，请审核后决定是否通过。',
      typeKey:'' },
    { module:'需求征集', moduleIndex:1, nodeKey:'1-3', nodeLabel:'需求申请表提交单位审批',
      seq:6, notifKind:'待办', channels:['system','email'],
    ...
    { module:'需求征集', moduleIndex:1, nodeKey:'1-4', nodeLabel:'单位内项目排序',
      seq:7, notifKind:'待办', channels:['system','dingding'],
    ...
    { module:'立项论证', moduleIndex:2, nodeKey:'2-1', nodeLabel:'填报立项申报书',
      seq:13, notifKind:'待办', channels:['system','email'],
      recipients:'UnitHandler',
    ...
    { module:'立项论证', moduleIndex:2, nodeKey:'2-2', nodeLabel:'信息办审核申报材料',
      seq:17, notifKind:'待办', channels:['system','email'],
      recipients:'UnitHandler',
    ...
    { module:'立项论证', moduleIndex:2, nodeKey:'2-4', nodeLabel:'专家论证与评审',
      seq:29, notifKind:'待办', channels:['system','email','dingding'],
      recipients:'Expert',
    ...
    { module:'立项论证', moduleIndex:2, nodeKey:'2-5', nodeLabel:'论证意见审核与公示',
      seq:32, notifKind:'待阅', channels:['system','email'],
      recipients:'UnitHandler',
    ...
    { module:'立项论证', moduleIndex:2, nodeKey:'2-6', nodeLabel:'领导小组审定与立项下达',
      seq:36, notifKind:'待阅', channels:['system','email'],
      recipients:'UnitHandler',
    ...
    { module:'立项论证', moduleIndex:2, nodeKey:'2-7', nodeLabel:'立项有效期预警',
      seq:40, notifKind:'待办', channels:['system','email','dingding'],
      recipients:'UnitHandler',
      title:'【紧急预警】「{{项目名称}}」采购截止日还剩 30 天，请尽快启动采购',
      body:'采购截止：{{日期}}，超期立项自动失效。',
      typeKey:'frozen-notice' },
    { module:'立项论证', moduleIndex:2, nodeKey:'2-7', nodeLabel:'立项有效期预警',
      seq:43, notifKind:'待阅', channels:['system','email'],
      recipients:'UnitHandler',
    ...
    { module:'招采管理', moduleIndex:3, nodeKey:'3-1', nodeLabel:'采购文件编制 & 技术审核',
      seq:47, notifKind:'待办', channels:['system','dingding'],
      recipients:'InfoStaff',
      title:'【待审核】「{{项目名称}}」采购文件待技术审核',
      body:'请审核技术规范与建设方案一致性、接口标准、安全防护、数据治理等内容。',
      typeKey:'' },
    { module:'招采管理', moduleIndex:3, nodeKey:'3-1', nodeLabel:'采购文件编制 & 技术审核',
      seq:49, notifKind:'待办', channels:['system','email'],
    ...
    { module:'招采管理', moduleIndex:3, nodeKey:'3-2', nodeLabel:'供应商调研校验',
      seq:51, notifKind:'待办', channels:['system'],
      recipients:'Procurement',
    ...
    { module:'招采管理', moduleIndex:3, nodeKey:'3-3', nodeLabel:'合同审核与签订',
      seq:52, notifKind:'待办', channels:['system','dingding'],
      recipients:'InfoStaff',
      title:'【待审核】「{{项目名称}}」合同草稿待审核',
      body:'合同金额：{{金额}}，请审核关键条款：建设内容、周期、数据治理、付款方式、维保年限。',
      typeKey:'' },
    { module:'招采管理', moduleIndex:3, nodeKey:'3-3', nodeLabel:'合同审核与签订',
      seq:58, notifKind:'待阅', channels:['system','email'],
      recipients:'UnitHandler',
    ...
    { module:'项目终止', moduleIndex:45, nodeKey:'4-5', nodeLabel:'终止申请',
      seq:82, notifKind:'待阅', channels:['system','email'],
      recipients:'UnitHandler',
      title:'【项目终止】「{{项目名称}}」已获批终止',
      body:'终止通知书已生成，请配合完成善后工作（资金退回/资产清查等）。',
      typeKey:'' },
    { module:'项目终止', moduleIndex:45, nodeKey:'4-5', nodeLabel:'终止申请',
      seq:83, notifKind:'待阅', channels:['system','email'],
      recipients:'Finance',
    ...
    { module:'项目验收', moduleIndex:5, nodeKey:'5-2', nodeLabel:'内部初验',
      seq:88, notifKind:'待办', channels:['system'],
      recipients:'UnitHandler',
    ...
    { module:'项目验收', moduleIndex:5, nodeKey:'5-3', nodeLabel:'试运行监控',
      seq:92, notifKind:'待办', channels:['system','dingding'],
      recipients:'UnitHandler',
      title:'【待办】「{{项目名称}}」试运行期满，可提交正式验收申请',
      body:'请整理验收材料并提交验收申请。',
      typeKey:'' },
    { module:'项目验收', moduleIndex:5, nodeKey:'5-4', nodeLabel:'信息办组织正式验收',
      seq:95, notifKind:'待办', channels:['system','email','dingding'],
      recipients:'Expert',
    ...
    { module:'项目验收', moduleIndex:5, nodeKey:'5-6', nodeLabel:'资产移交与归档',
      seq:107, notifKind:'待办', channels:['system'],
      recipients:'InfoStaff',
    ...
    { module:'运维管理', moduleIndex:6, nodeKey:'6-4', nodeLabel:'合同到期提醒',
      seq:117, notifKind:'待阅', channels:['system','email'],
  ...
  function _renderTmplContent(data) {
    ...
    data.forEach(function(t) {
      ...
      var nodeKey = t.nodeKey + '|' + t.nodeLabel;
      if (!moduleMap[t.module][nodeKey]) moduleMap[t.module][nodeKey] = [];
      moduleMap[t.module][nodeKey].push(t);
    });

    var html = '';
    moduleOrder.forEach(function(mod, mi) {
      if (!moduleMap[mod]) return;
      var nodeMap = moduleMap[mod];
      ...
      html += '<div class="card" style="margin-top:16px">' +
        '<div class="card-title" style="font-size:15px;margin-bottom:16px">' + modTitle + '</div>';

      Object.keys(nodeMap).forEach(function(nodeKey) {
        var parts = nodeKey.split('|');
        var nKey = parts[0], nLabel = parts[1];
        var items = nodeMap[nodeKey];
        ...
        items.forEach(function(t) {
          ...
          html += '<tr>' +
            '<td style="color:var(--text-secondary)">' + t.seq + '</td>' +
            '<td style="color:var(--text-secondary);font-size:12px">' + t.recipients + '</td>' +
            '<td>' + kindTag + '</td>' +
            '<td>' + _tmplChannelBadges(t.channels) + '</td>' +
            '<td style="max-width:280px;word-break:break-all">' + t.title + '</td>' +
            '<td style="max-width:220px;color:var(--text-secondary);font-size:12px;word-break:break-all">' + (t.body||'—') + '</td>' +
  ...
  return '' +
    ...
    '    data.forEach(function(t) {' +
    '      if (!moduleMap[t.module]) moduleMap[t.module] = {};' +
    '      var nk = t.nodeKey+"|"+t.nodeLabel;' +
    '      if (!moduleMap[t.module][nk]) moduleMap[t.module][nk] = [];' +
    '      moduleMap[t.module][nk].push(t);' +
    '    });' +
    '    var html = "";' +
    ...
    '      var modIdx = idx ? idx.moduleIndex : (mi+1);' +
    '      var modTitle = mod==="项目终止" ? "模块四附：项目终止" : ("模块"+modIdx+"："+mod);' +
    '      html += \'<div class="card" style="margin-top:16px"><div class="card-title" style="font-size:15px;margin-bottom:16px">\'+modTitle+"</div>";' +
    '      Object.keys(nodeMap).forEach(function(nk) {' +
    '        var parts=nk.split("|"); var nKey=parts[0]; var nLabel=parts[1];' +
    '        var items=nodeMap[nk];' +
    '        html += \'<div style="margin-bottom:16px"><div style="font-size:12px;font-weight:600;color:var(--text-secondary);margin-bottom:8px">节点 \'+nKey+" "+nLabel+"</div>";' +
    '        html += \'<table class="data-table" style="font-size:13px"><thead><tr><th style="width:32px">#</th><th>接收角色</th><th style="width:58px">类型</th><th style="width:90px">渠道</th><th>通知标题</th><th>正文摘要</th><th style="width:110px">操作</th></tr></thead><tbody>\';' +
    '        items.forEach(function(t) {' +
    ...
    '          html += "<tr><td style=\\"color:var(--text-secondary)\\">" + t.seq + "</td><td style=\\"color:var(--text-secondary);font-size:12px\\">" + t.recipients + "</td><td>" + kt + "</td><td>" + _tmplChannelBadges(t.channels) + "</td><td style=\\"max-width:280px;word-break:break-all\\">" + t.title + "</td><td style=\\"max-width:220px;color:var(--text-secondary);font-size:12px;word-break:break-all\\">" + (t.body||"—") + "</td><td>" + ub + eb + "</td></tr>";' +
    '        });' +
    '        html += "</tbody></table></div>";' +
    '      });' +
    '      html += "</div>";' +
