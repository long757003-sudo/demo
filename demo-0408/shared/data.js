...
window.DATA = {
  ...
  notifications: [
    ...
    { id: 'N016', type: 'contract-expiry', title: '合同到期提醒 — OA协同办公平台升级', content: 'OA协同办公平台升级」维保合同将于30天内到期，请及时确认续签或终止。', sender: '系统', sendTime: '2025-12-31 06:00', recipients: ['contract-admin','project-manager'], level: 'warning', readStatus: {'周合同':false}, deliveryStatus: {'周合同':'delivered'}, channel: ['system'] },
  ],
  operationLogs: [
